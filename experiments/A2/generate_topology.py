...
for i in range(0, num_rounds):
    ...
    for num_sfc_request in num_sfc_requests:
        ...
        # new cpu value in each round
        new_cpu = 3500 * (num_sfc_request / 100)
        ...
        for node in environment['nodes'].keys():
            environment['nodes'][node]['cpu'] = int(new_cpu)
            environment['nodes'][node]['mem'] = int(new_cpu)
